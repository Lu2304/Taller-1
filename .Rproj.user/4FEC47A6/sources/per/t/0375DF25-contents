...
pkgs <- c("rio", "tidyverse", "skimr", "stargazer", "dplyr", "tidyr", 
          "corrplot", "pacman", "rvest", "flextable", "officer", "ggplot2",
          "boot", "broom", "caret", "Metrics", "janitor")
...
# Regresiones
source(file.path("Code", "02_regressions.R"))
# Predicciones
source(file.path("Code", "03_predictions.R"))